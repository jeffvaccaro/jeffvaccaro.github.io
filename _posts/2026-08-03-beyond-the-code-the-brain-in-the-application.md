...
Researching what an LLM actually was took me into the world of Hugging Face and Ollama. Honestly, I didn't know what I was doing. I had to learn how to install Ollama into my own application, how to call the different local models, what tokens even were, and the limits of running everything on CPU versus GPU. It was a lot of new information all at once, and it was a little overwhelming at first.
